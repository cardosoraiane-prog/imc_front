if (
  window.GeolocationCoordinates.pathname.endsWith("index.html") &&
...
function formatarResposta(resultado) {
  ...
  let html = `<div style="padding:15px;background:#d4eda;color:#155724;border:1px solid #c3e6cb;border-radius:5px;"`;
